...
import CustomMoreButton from "./OptionButton";
import CustomAddButton from "./AdditionButton";
import FeatureRequest from "./RequestDiv";
import ProfileIcon from "./ProfileIcon";
import StatusIcon from "./IconStatus";
    ...
    <React.Fragment>
      {Object.keys(groupedTickets_user).map((userId) => (
        <Grid item lg={2.4} key={userId} padding={2}>
          ...
          <ul style={{ listStyle: "none", padding: 0, boxShadow: "0px 0px 0px black"}}>
